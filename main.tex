...
% Uncomment for Finnish thesis
% \renewcommand{\thesislanguage}{finnish}
...
\newenvironment{writexmpdata}
  {\newwrite\myxmp \immediate\openout\myxmp=\jobname.xmpdata}
  {\immediate\closeout\myxmp}

% Usage
\begin{writexmpdata}
\immediate\write\myxmp{\string\Title{\maintitle}}
\immediate\write\myxmp{\string\Author{\getauthors{, }}}
\immediate\write\myxmp{\string\Language{en-GB}}
\immediate\write\myxmp{\string\Keywords{\keywords}}
\immediate\write\myxmp{\string\Publisher{University of Oulu}}
\end{writexmpdata}
