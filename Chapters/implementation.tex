...
Finnish. International students \textbf{also require a Finnish abstract and title} (your supervisor can help with getting a native speaker to verify these).
If the language of the thesis is English, the abstract in English comes
...
\begin{center}
  \includegraphics*[width=0.7\textwidth,
    ...
    arrow shows WP3 also directly feeding into WP5.}]{WP}
\end{center}
...
\begin{center}
  \includegraphics*[width=0.9\textwidth,
    alt={Cartoon of a person running outside at night howling at the moon in frustration.}]{unto_uneksija}
\end{center}
...
The tool can be found in Moodle \url{https://moodle.oulu.fi/enrol/index.php?id=31794} (Link valid for 2026). The thesis is checked individually, so the originality of the text can be confirmed.
...
\begin{center}
  \includegraphics[width=12cm,
    alt={Black and white portrait photograph of Stephen Crane.}]{Figures/ccby.jpg}
\end{center}
