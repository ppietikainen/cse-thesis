...
The abbreviations of terms, variables and measurement units as well as
...
% Punctuation is placed inside \text{}, LaTeX changes . to , otherwise
\begin{equation}
    v = \frac{s}{t}\text{,}
    \label{eq:speed}
\end{equation}
