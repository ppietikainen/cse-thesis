...
the author of the thesis is also the author and copyright owner (not necessarily the author) of the figure, and the license of the figure is the same as the document (Default: ``All rights reserved''). This is discussed further in Section~\secref{copyright}.
